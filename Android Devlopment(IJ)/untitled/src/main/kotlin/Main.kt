...
//any variable
        var x1=5
        var y2=90
        println("My integer ${x1}") //$ is concatenated with variable name to replace it with the value in a statement
        println("My long integer $x1") //curly brackets for just getting the value is optional
        println("My long integer ${y2+6}") //curly brackets to make it work life an operation are mandatory i.e it meas first replace y with 90 and then add 5 to it.
        println("My long integer ${y2}")
